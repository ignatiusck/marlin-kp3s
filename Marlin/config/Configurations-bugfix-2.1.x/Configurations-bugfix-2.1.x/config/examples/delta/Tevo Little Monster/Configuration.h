...
#define STRING_CONFIG_H_AUTHOR "(lemmingDev, community)" // Original author or contributor.
...
#define DELTA
  ...
  #define DELTA_ENDSTOP_ADJ { 0.0, -2.54, -0.53 } // (mm) Get these values from G33 auto calibrate
  ...
  #define DELTA_TOWER_ANGLE_TRIM { -0.12, 0.11, 0.01 } // (mm) Get these values from G33 auto calibrate
