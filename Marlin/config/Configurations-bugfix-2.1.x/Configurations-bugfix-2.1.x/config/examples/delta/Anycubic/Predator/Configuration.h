...
#define STRING_CONFIG_H_AUTHOR "(SXH, Predator STM)" // Original author or contributor.
...
#define DELTA
  ...
  #define DELTA_TOWER_ANGLE_TRIM { +0.13, -0.18, +0.05 } // (mm) Get these values from G33 auto calibrate
...
#define Z_AFTER_PROBING           300 // (mm) Z position after probing is done
