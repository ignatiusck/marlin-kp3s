...
#define CONFIG_EXAMPLES_DIR "delta/FLSUN/Q5-nano_v2"
...
#define STRING_CONFIG_H_AUTHOR "(mgcrea, Q5 config)" // Original author or contributor.
...
#define Z_AFTER_PROBING            30 // (mm) Z position after probing is done
