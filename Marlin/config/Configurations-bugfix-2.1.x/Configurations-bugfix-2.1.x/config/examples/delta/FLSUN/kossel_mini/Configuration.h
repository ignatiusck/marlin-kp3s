...
#define STRING_CONFIG_H_AUTHOR "(Michael Henke, flsun Kossel Mini)" // Original author or contributor.
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_MIN_POS + X_MAX_POS) / 2)    // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT ((Y_MIN_POS + Y_MAX_POS) / 2)    // (mm) Y point for Z homing
