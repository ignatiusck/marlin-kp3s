...
#define STRING_CONFIG_H_AUTHOR "(John Ecker, Kossel Clear)" // Original author or contributor.
...
#define DELTA
  ...
  #define DELTA_TOWER_ANGLE_TRIM {0.0, 0.0, -0.584 } // (mm) Get these values from G33 auto calibrate
