...
#define STRING_CONFIG_H_AUTHOR "(Bob Kuhn)" // Original author or contributor.
...
#define XY_PROBE_FEEDRATE 6500      // (90*60)
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    6 // (mm) Z Clearance for Deploy/Stow
...
#define Z_CLEARANCE_FOR_HOMING    6   // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
