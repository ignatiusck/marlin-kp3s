...
#define Z_CLEARANCE_FOR_HOMING  20    // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_Z_HOP       6.0        // (mm) Z raise between tramming points
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_STROKES     12   // Default number of pattern repetitions
    ...
    #define NOZZLE_CLEAN_TRIANGLES  6   // Default number of triangles
  #endif
