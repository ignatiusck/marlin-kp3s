...
#define CONFIG_EXAMPLES_DIR "ORD Bot/Hadron/Sanguinololu"
...
#define STRING_CONFIG_H_AUTHOR "(thinkyhead, Sanguinololu)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "ORD Bot Hadron"
