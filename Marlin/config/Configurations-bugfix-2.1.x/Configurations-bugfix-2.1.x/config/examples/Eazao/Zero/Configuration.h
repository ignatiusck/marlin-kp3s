...
#define CONFIG_EXAMPLES_DIR "Eazao/Zero"
...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Eazao Zero"
...
#define EXTRUDE_MAXLENGTH 200000
