...
#define CONFIG_EXAMPLES_DIR "Sovol/SV-05"
...
#define STRING_CONFIG_H_AUTHOR "(MRR0GERS, Sovol3d SV05)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Sovol3D SV05"
