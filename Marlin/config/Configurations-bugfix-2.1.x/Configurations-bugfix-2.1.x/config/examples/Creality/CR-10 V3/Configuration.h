...
#define Z_CLEARANCE_BETWEEN_PROBES  3 // (mm) Z Clearance between probe points (Stock: 5)
#define Z_CLEARANCE_MULTI_PROBE     3 // (mm) Z Clearance between multiple probes (Stock: 5)
