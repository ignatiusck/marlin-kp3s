...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-3 S1/STM32F4"
...
#define STRING_CONFIG_H_AUTHOR "(tiagofreire-pt, Ender-3 S1 F4)" // Original author or contributor.
...
#define Z_AFTER_HOMING         30     // (mm) Height to move to after homing (if Z was homed)
