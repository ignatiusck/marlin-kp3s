...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-3/BigTreeTech Manta E3 EZ"
...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, Ender-3)" // Original author or contributor.
 ...
 */
#define SERIAL_PORT -1     // USB Connected to CB1/CM4
 ...
 */
#define SERIAL_PORT_2 3     // TFT Port
...
#define HEATER_0_MAXTEMP 275 // 260 + 15
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 13.33f }          // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1299f }       // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1163f }          // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1245f } // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
