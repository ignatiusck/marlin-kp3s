...
#define CONFIG_EXAMPLES_DIR "Creality/CR-10/BigTreeTech SKR Mini E3 3.0"
...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, CR-10 / SKR Mini E3 V3)" // Original author or contributor.
