...
#define STRING_CONFIG_H_AUTHOR "(Victor Perez)" // Original author or contributor.
...
#define PID_MAX  180      // Limit hotend current while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
 ...
 */
  ...
  #define MPC_MAX 180                                 // (0..255) Current to nozzle while MPC is active.
