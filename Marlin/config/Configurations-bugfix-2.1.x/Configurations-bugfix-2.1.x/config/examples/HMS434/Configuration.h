...
#define STRING_CONFIG_H_AUTHOR "(Scheepers, MaukCC)" // Original author or contributor.
...
#define PID_MAX  170      // Limit hotend current while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_STROKES      4   // Default number of pattern repetitions
    ...
    #define NOZZLE_CLEAN_TRIANGLES  2   // Default number of triangles
  #endif
  ...
  #define NOZZLE_CLEAN_END_POINT   { 100, 60, (Z_MIN_POS + 1) }
    ...
    #define NOZZLE_CLEAN_CIRCLE_RADIUS 8                        // (mm) Circular pattern radius
