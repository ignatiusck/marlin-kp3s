...
#define CONFIG_EXAMPLES_DIR "Tronxy/XY2-Pro"
...
#define STRING_CONFIG_H_AUTHOR "(maksymovi, Tronxy XY2-Pro)" // Original author or contributor.
 ...
 */
#define X_DRIVER_TYPE  TMC2208_STANDALONE //XY2-Pro all use the TMC-2225-SA
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 100, 5000 } //values taken from https://github.com/rhapsodyv/Marlin/
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.022 // (mm) Distance from real junction edge, taken from https://github.com/rhapsodyv/Marlin/
