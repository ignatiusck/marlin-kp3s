...
#define CONFIG_EXAMPLES_DIR "Ultimaker/Ultimaker Original Plus DXU"
...
#define STRING_CONFIG_H_AUTHOR "(Anson Liu, UMO+ DXU)" // Original author or contributor.
 ...
 */
#define Z_MIN_PROBE_PIN 69 // Pin 32 is the RAMPS default
