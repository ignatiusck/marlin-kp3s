...
#define STRING_CONFIG_H_AUTHOR "(Dana Olson&Eryone, All in one config)" // Original author or contributor.
...
#define Z_MIN_ENDSTOP_HIT_STATE TERN(THINKERV2_BLTOUCH, HIGH, LOW)
 ...
 */
#if DISABLED(BLTOUCH, FIX_MOUNTED_PROBE)
