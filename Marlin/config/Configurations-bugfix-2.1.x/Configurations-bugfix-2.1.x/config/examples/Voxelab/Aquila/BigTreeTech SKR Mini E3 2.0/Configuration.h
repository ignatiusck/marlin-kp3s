...
#define CONFIG_EXAMPLES_DIR "Voxelab/Aquila/BigTreeTech SKR Mini E3 2.0"
...
#define STRING_CONFIG_H_AUTHOR "(Palpalych, Aquila C2 (BigTreeTech SKR Mini E3 2.0))" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Voxelab Aquila C2"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 101 } // Attention! The stock printer has a different extruder gear, so the number of steps for this one is 101 (unlike Ender-3 where it is 93)
