...
#define CONFIG_EXAMPLES_DIR "Printrbot/Simple_Metal_RevF6"
...
#define STRING_CONFIG_H_AUTHOR "(rngkll)" // Original author or contributor.
...
#define Z_CLEARANCE_FOR_HOMING  3     // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
