...
#define CONFIG_EXAMPLES_DIR "Rolohaun/Rook MK1"
...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, Rolohaun Rook MK1 by LDO Motors)" // Original author or contributor.
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 6.52f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.3518f }       // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0664f }          // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0774f } // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
//
#define CR10_STOCKDISPLAY // BigTreeTech TFT35
