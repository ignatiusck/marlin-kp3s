...
#define STRING_CONFIG_H_AUTHOR "(davidtgbe, default config)" // Original author or contributor.
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_HEIGHT      0.05       // (mm) Z height of nozzle at tramming points
