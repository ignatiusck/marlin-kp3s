...
#define STRING_CONFIG_H_AUTHOR "(Credomane, Tinkerine Ditto Pro)" // Original author or contributor.
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 0, 0, 0, 0 } // (mm) Left, Front, Right, Back insets
