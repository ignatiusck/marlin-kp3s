...
#define CONFIG_EXAMPLES_DIR "Opulo/Lumen_REV4"
...
#define Z_AFTER_HOMING         31.5   // (mm) Height to move to after homing (if Z was homed)
...
#define X_BED_SIZE 433
#define Y_BED_SIZE 487
